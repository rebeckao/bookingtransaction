...
public class IntegrationTests {
    ...
    @Test
    void processTransactionForUserWithCreditLimit() {
        client.put()
                .uri("/set-credit-limits")
                .bodyValue(List.of(new UserEntity("john@doe.com", 200)))
                .exchange()
                .expectStatus()
                .isOk();
        ...
        client.post()
                ...
                .bodyValue("John,Doe,john@doe.com,190,TR0001")
                .exchange()
                .expectStatus()
                .isOk()
    ...
    @Test
    void processTransactionForUserWithoutCreditLimit() {
        client.post()
                .uri("/process-transactions")
                .bodyValue("John,Doe,john@doe.com,190,TR0001")
                .exchange()
                ...
                .isEqualTo(new TransactionResponse(List.of(
                        new RejectedTransaction("John", "Doe", "john@doe.com", "TR0001")
                )));
    }

    @Test
    void processTransactionForUserWithoutInsufficientCreditLimit() {
        client.put()
                .uri("/set-credit-limits")
                .bodyValue(List.of(new UserEntity("john@doe.com", 100)))
                .exchange()
                .expectStatus()
                .isOk();
